	# A fun��o insert() permite inserir a string "src" na string "dst", a partir da posi��o 
	# "pos". 	
...
insert_char:
	...
	addiu $sp,$sp,-32 	# reserva espa�o na stack
...
endf2:				# }
	...
	lw $s4,20($sp)		# rep�r $s4
	lw $s5,24($sp)		# rep�r $s5
	lw $s6,28($sp)		# rep�r $s6
	addiu $sp,$sp,32 	# libertar espa�o na stack
